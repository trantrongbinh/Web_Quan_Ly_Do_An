            ...
            <div class="col-md-9">
                <div class="panel panel-default">            
                    <div class="panel-heading" style="background-color:#337AB7; color:white;" >
                        ...
                        <p style="text-align:center; margin-top: 15px;"><a href="canhan.php?ms_sv=<?=$_SESSION['mssv']?>" class="button_them">Trở về</a></p>
                    </div>
                    <div class="panel-body">
                        ...
                        <form method="post" name="form_them">
                            <div class="them_ten_dt">
                                <label  class="col-md-4" for="ten_dt">Tên đề tài</label>
                                <input  class="col-md-8" type="text" id="tendt" name="ten_dt">
                            </div>
                            <div  style="padding-top: 40px;"></div>
                            <div class="congnghe">
                                <label  class="col-md-4" for="ten_dt">Công nghệ</label>
                            ...
                            <div class="them_tensv">
                                ...
                                <select  class="col-md-8" id="magv" name="gv">
                                    ...
                                    <option value="">GV 3</option>
                                    <option value="">GV 4</option>
                                </select>
                            </div>
                            <div  style="padding-top: 40px;"></div>
                            <div class="chon_bomon">
                                <label  class="col-md-4" for="manh">Loại</label>
                                <select  class="col-md-8" id="manh" name="nh">
                                <option value="">---Select---</option>
                                <option value="">Đồ Án Chuyên Ngành CNPM</option>
                                <option value="">Dồ Án Tốt Nghiệp CNPM</option>
                                <option value="">Dồ Án Tự Do CNPM</option>
                                </select>
                            </div>
                            <div  style="padding-top: 40px;"></div>
